            ...
            <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
                <div className="flex itemns-center gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        />
                        <p className="text-zinc-700 text-xm space-x-1">
                            <span>/</span>
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button className="gap-1.5" aria-label="zoom" variant="ghost">
                                ...
                                {scale * 100}%<ChevronDown className="h-2 w-2 opacity-50" />
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent>
                            <DropdownMenuItem onSelect={() => setScale(0.10)}>
                                10%
                            </DropdownMenuItem>
                    ...
                    <div ref={ref}>
                        <Document
                            ...
                            <Page
                                ...
                                loading={
                                    <div className="flex justify-center">
                                        <Loader2 my-24 h-6 w-6 animate-spin />
                                    </div>
                                }
